...
@interface PropertyViewController () <footerdelegate,UIGestureRecognizerDelegate>
{
    RightMenu *rightView;
    BOOL rightslide;
    Footer *footerView;
...
{
    PropertyTableViewCell *cell=(PropertyTableViewCell *)[tableView dequeueReusableCellWithIdentifier:@"property"];
    return cell;
}
